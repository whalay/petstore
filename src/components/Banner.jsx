...
const Banner = () => {
  return (
    <div className=" bg-[url('./assets/images/bannerb1.svg')]  bg-contain bg-no-repeat md:bg-none md:h-[73vh]  bg-[#002A48] m-5  flex flex-col md:flex-row-reverse items-center text-center justify-center md:text-right   rounded-xl">
      <div className=" md:bg-[url('./assets/images/bannerb.svg')]  bg-no-repeat bg-cover w-full  flex p-5 md:h-[73vh]  justify-center  text-center md:text-right basis-[100%] flex-col gap-y-3 z-50">
